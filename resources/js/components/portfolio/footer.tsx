...
export default function Footer() {
    ...
    return (
        <footer className="border-line text-fg-dim flex flex-col items-start justify-between gap-4 border-t px-6 py-10 font-mono text-[11px] md:flex-row md:items-center md:px-12">
