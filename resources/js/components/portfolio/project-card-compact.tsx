        ...
        >
            ...
            <div className="flex flex-1 flex-col p-6">
                <div className="flex items-baseline justify-between gap-4">
                    <h3 className="text-fg text-[20.5px] leading-tight font-medium tracking-tight">{project.name}</h3>
                    <span className="text-fg-dim shrink-0 font-mono text-[13.5px] tabular-nums">{project.year}</span>
                </div>

                {project.tag && (
                    <span className="text-portfolio-accent mt-1.5 font-mono text-[13.5px]">{project.tag}</span>
                )}

                <p className="text-fg-mid mt-3 line-clamp-2 text-[15.5px] leading-relaxed">{project.blurb}</p>
